...
static void displayMenu() {
    ...
    cout << "5. Загрузить данные из 'input.txt'" << endl;
    cout << "6. Сохранить данные в 'output.txt'" << endl;
    cout << "0. Выход" << endl;
    cout << "Введите выбор: ";
}
...
int main() {
    ...
    do {
        ...
        case 4: {
            ...
            if (node) {
                cout << "Найден узел с ключом: " << node->key << endl;
            }
            else {
        ...
        case 5: {
            system("cls");
            readFromFile(root, "input.txt");
            cout << "Дерево построено из файла 'input.txt'." << endl;
            break;
        }
        case 6: {
            system("cls");
            writeToFile(root, "output.txt");
