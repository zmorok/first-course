...
// подсчет количества левых дочерних вершин в дереве
...
static void displayMenu() {
    ...
    cout << "7. Подсчитать количество левых дочерних вершин дерева" << endl;
    cout << "0. Выход" << endl;
    cout << "Введите выбор: ";
}
...
int main() {
    ...
    do {
        ...
        case 7: {
            ...
            if (count) {
                cout << "В дереве " << count << " левых дочерних узлов." << endl;
            }
            else {
                cout << "В дереве нет левых дочерних узлов." << endl;
            }
            break;
        }
        case 0:
