...
int main() {
    ...
    do {
        ...
        cout << 
            "1. Добавить элемент\n" << 
            "2. Удалить элемент\n" << 
            "3. Проверить на наличие повторного следующего\n" <<
            "4. Записать в файл\n" << 
            "5. Прочитать с файла\n" <<
            "6. Отобразить стек\n" <<
            "7. Очистить стек\n" << 
        ...
        case 3: {
            system("cls");
            if (hasDuplicateNext(top)) {
                cout << "В стеке есть дублированный следующий элемент." << endl;
            }
            else {
                cout << "В стеке нет дублированного следующего элемента." << endl;
            }
            system("pause");
            break;
        }
